...
<style>
  ...
  /* MENU FLOTTANT HAUT (Sélecteur de métier) */
  ...
  /* MENU FLOTTANT BAS (Slider Temporel) */
  ...
  .floating-slider-wrapper input[type=range] {
    ...
    width: 100%;
    background: linear-gradient(to right, #1e3a8a, #3b82f6, #00f6ff);
    height: 8px;
    border-radius: 4px;
    outline: none;
    margin-top: 10px;
...
<!-- CONTENEUR COMMUN : menus + carte superposés -->
<div style="position: relative; width: 100%;">

  <!-- Menu sélecteur de métier (haut gauche) -->
...
```js
// Filtrage et mise à jour de la heatmap
...
<div class="card">
  <h3>🔍 Données détaillées — ${selectedMetier} (${anneesUniques[selectedAnneeIndex]})</h3>
